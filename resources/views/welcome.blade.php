...
<head>
    ...
    <!-- Page Title -->
    <title> ÁGOTA & BÁLINT 2023.06.10</title>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="couple-logo">
                        <h1><a href="#home">ÁGOTA & BÁLINT</a></h1>
                    </div>
                </div>
                <div id="navbar" class="navbar-collapse collapse navbar-right navigation-holder">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#rsvp">Visszajelzés</a></li>
                    </ul>
    ...
    <section class="getting-there-section section-padding">
        <div class="container">
            ...
            <div class="row content">
                ...
                <div class="col col-md-6">
                    <h3>Szállás</h3>
                    <p>Létszámtól függően a Vadászházban vagy a Palota Panzióban.</p>
                </div>
            </div> <!-- end row -->
        </div> <!-- end container -->
    </section>
...
{{--                        </div>--}}
                        <div class="details">
                            <h3>Morzsaparti</h3>
                            <ul>
                                <li><i class="fa fa-clock-o"></i> Másnap reggel</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!-- start rsvp-section -->
    <section class="rsvp-section section-padding parallax" data-bg-image="images/back.jpg" data-speed="7" id="rsvp" style="">
        <div class="container">
            <div class="row">
                <div class="col col-xs-12">
                    <div class="section-title-white">
...
{{--                        </div>--}}
                        ...
                        <div class="col col-sm-12">
                            <label class="white" for="accommodation">Szállás  <small>(~13.000, - Ft / fő / éj)</small> </label>
                            <select class="form-control" id="accommodation" name="accommodation">
                                <option selected>Kérek</option>
                                <option>Nem kérek</option>
                            </select>
                        </div>
                        <div class="col col-sm-12">
